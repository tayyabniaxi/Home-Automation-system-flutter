...
class Lightfour extends StatefulWidget {
  @override
  _LightfourState createState() => _LightfourState();
}

class _LightfourState extends State<Lightfour> {
...
//this function calls when press on mic icon
  ...
  void handleSwitch() {
    ...
    if (fanState == 1) {
      espServices.turnOnLed('led4');
    } else {
      espServices.turnOffLed('led4');
    }
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('(Light4)Speech to Text'),
        ),
        body: Center(
          child: Column(
