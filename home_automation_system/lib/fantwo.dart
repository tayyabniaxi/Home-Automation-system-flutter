...
class Fantwo extends StatefulWidget {
  @override
  _FantwoState createState() => _FantwoState();
}

class _FantwoState extends State<Fantwo> {
...
//this function calls when press on mic icon
  ...
  void handleSwitch() {
    ...
    if (fanState == 1) {
      espServices.turnOnLed('fan2');
    } else {
      espServices.turnOffLed('fan2');
    }
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('(Fan2)Speech to Text'),
        ),
        body: Center(
          child: Column(
