...
class Lightthree extends StatefulWidget {
  @override
  _LightthreeState createState() => _LightthreeState();
}

class _LightthreeState extends State<Lightthree> {
...
//this function calls when press on mic icon
  ...
  void handleSwitch() {
    ...
    if (fanState == 1) {
      espServices.turnOnLed('led3');
    } else {
      espServices.turnOffLed('led3');
    }
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('(Light3)Speech to Text'),
        ),
        body: Center(
          child: Column(
