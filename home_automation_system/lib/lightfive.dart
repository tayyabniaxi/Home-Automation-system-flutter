...
class Lightfive extends StatefulWidget {
  @override
  _LightfiveState createState() => _LightfiveState();
}

class _LightfiveState extends State<Lightfive> {
...
//this function calls when press on mic icon
  ...
  void handleSwitch() {
    ...
    if (fanState == 1) {
      espServices.turnOnLed('led5');
    } else {
      espServices.turnOffLed('led5');
    }
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('(Light5)Speech to Text'),
        ),
        body: Center(
          child: Column(
